    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between mb-6">
                <div>
                    <h1 class="text-3xl font-bold text-white mb-2">Quản lý Backup & Restore</h1>
                    <p class="text-gray-400">Tạo, quản lý và khôi phục dữ liệu hệ thống</p>
                </div>
        ...
        <div class="bg-gray-800 rounded-xl border border-gray-700 overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-700">
                <h3 class="text-lg font-semibold text-white">Danh sách Backup</h3>
            </div>
                    ...
                    <table class="w-full">
                        <thead class="bg-gray-700">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Người tạo</th>
            ...
            @else
                <div class="px-6 py-12 text-center">
                    ...
                    <p class="text-gray-400 mb-4">Tạo backup đầu tiên để bảo vệ dữ liệu hệ thống</p>
                    <a href="{{ route('backups.create') }}" 
                       class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium transition-colors duration-200">
                        Tạo Backup đầu tiên
                    </a>
...
<div id="cleanupModal" class="fixed inset-0 bg-black bg-opacity-50 hidden z-50">
    <div class="flex items-center justify-center min-h-screen p-4">
        <div class="bg-gray-800 rounded-xl border border-gray-700 p-6 w-full max-w-md">
            <h3 class="text-lg font-semibold text-white mb-4">Dọn dẹp Backup cũ</h3>
            <p class="text-gray-400 mb-6">Xóa các backup cũ để tiết kiệm dung lượng lưu trữ.</p>
            
            <form method="post" action="{{ route('backups.cleanup') }}" class="space-y-4">
                @csrf
                
                <div>
                    <label for="days_to_keep" class="block text-sm font-medium text-gray-300 mb-2">Giữ lại backup trong (ngày)</label>
            ...
            <form id="restoreForm" method="post" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" id="restore_description" name="description" 
                           class="w-full bg-gray-700 border border-gray-600 rounded-lg px-4 py-2 text-white placeholder-gray-400 focus:outline-none focus:border-blue-500"
                           placeholder="Mô tả lý do restore">
                </div>
...
function showRestoreModal(backupId, filename) {
    ...
    document.getElementById('restore_description').value = `Restore từ backup: ${filename}`;
