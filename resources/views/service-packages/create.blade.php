    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="mb-8">
            <div class="flex items-center mb-6">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-white mb-2">Create New Service Package</h1>
                    <p class="text-gray-400">Create a new service package with features and limits</p>
                </div>
            </div>
        </div>
                    ...
                    <div class="border-b border-gray-700 pb-6">
                        ...
                        <div class="mt-6">
                            ...
                            <textarea id="description" 
                                      ...
                                      rows="3"
                                      class="w-full bg-gray-700 border border-gray-600 rounded-lg px-4 py-2 text-white placeholder-gray-400 focus:outline-none focus:border-blue-500"
                                      placeholder="Detailed description of the package...">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                            @enderror
                        </div>
