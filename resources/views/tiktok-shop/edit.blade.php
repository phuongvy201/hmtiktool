        ...
        <div class="mb-8">
            <div class="flex items-center mb-6">
                ...
                <div>
                    ...
                    <p class="text-gray-400">Update integration information for team: <span class="text-blue-400 font-medium">{{ $integration->team->name }}</span></p>
                </div>
            </div>
        </div>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="bg-gray-700 rounded-lg p-4">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-400 mb-1">Team ID</label>
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" id="app_key" name="app_key" value="{{ old('app_key', $integration->app_key) }}" required
                                       ...
                                       placeholder="Enter App Key from TikTok Partner Center">
                                @error('app_key')
                            ...
                            <div>
                                ...
                                <input type="password" id="app_secret" name="app_secret" value="{{ old('app_secret', $integration->app_secret) }}" required
                                       ...
                                       placeholder="Enter App Secret from TikTok Partner Center">
                                @error('app_secret')
                                    <p class="text-red-400 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="bg-gray-700 rounded-lg p-4">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                            <label class="block text-sm font-medium text-gray-400 mb-1">Shop name</label>
                                    <p class="text-white">{{ $integration->shop_name }}</p>
                                </div>
                                @endif
                                @if($integration->error_message)
                                <div>
                                    <label class="block text-sm font-medium text-gray-400 mb-1">Error</label>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="bg-red-500/10 border border-red-500/20 rounded-lg p-4">
                            <ul class="list-disc list-inside space-y-2 text-gray-300 text-sm">
                                <li>When updating App Key/Secret, status will reset to "Waiting for verification"</li>
                                <li>Team admin will need to re-perform the authorization process for TikTok Shop</li>
                                <li>Current token information will be deleted when updating</li>
                                <li>Only update when truly necessary</li>
                            </ul>
                        </div>
                    </div>
