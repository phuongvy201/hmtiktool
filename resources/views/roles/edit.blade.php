    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="mb-8">
            <div class="flex items-center mb-6">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-white mb-2">Chỉnh sửa Vai trò</h1>
                    <p class="text-gray-400">Cập nhật thông tin vai trò: {{ $role->name }}</p>
                </div>
            </div>
        </div>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="bg-gray-700 rounded-lg p-4">
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                                <div>
                                    <span class="text-gray-400">Số quyền hạn hiện tại:</span>
