        ...
        <div class="mb-8">
            <div class="flex justify-between items-center mb-6">
                <div class="flex items-center">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold text-white mb-2">Chi tiết Thành viên</h1>
                        <p class="text-gray-400">Thông tin chi tiết về thành viên: <span class="text-blue-400 font-medium">{{ $user->name }}</span></p>
                    </div>
                </div>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-gray-800 rounded-xl border border-gray-700 p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-400 mb-1">ID người dùng</label>
                            <p class="text-gray-300">{{ $user->id }}</p>
                        </div>
                        
                        <div>
                            <label class="block text-sm font-medium text-gray-400 mb-1">Ngày tham gia</label>
                ...
                <div class="bg-gray-800 rounded-xl border border-gray-700 p-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-400 mb-2">Vai trò hiện tại</label>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-400 mb-2">Quyền hạn</label>
                            ...
                            @else
                                <span class="text-gray-500 text-sm">Không có quyền hạn riêng</span>
                            @endif
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gray-800 rounded-xl border border-gray-700 p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label class="block text-sm font-medium text-gray-400 mb-2">Xác thực email</label>
                            @if($user->email_verified_at)
                                ...
                                <p class="text-gray-400 text-sm mt-1">Xác thực lúc: {{ $user->email_verified_at->format('d/m/Y H:i') }}</p>
                            @else
                                <div class="flex items-center">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-400 mb-2">Trạng thái hoạt động</label>
                            <div class="flex items-center">
                                <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-green-500/20 text-green-400 border border-green-500/30">
                                    <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div class="bg-gray-800 rounded-xl border border-gray-700 p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label class="block text-sm font-medium text-gray-400 mb-1">Lần đăng nhập cuối</label>
                            @if($user->last_login_at)
                                <p class="text-gray-300">{{ $user->last_login_at->format('d/m/Y H:i') }}</p>
                            @else
                                <p class="text-gray-500 text-sm">Chưa đăng nhập</p>
                            @endif
                        </div>
                        
                        <div>
                            <label class="block text-sm font-medium text-gray-400 mb-1">Số lần đăng nhập</label>
                            <p class="text-gray-300">{{ $user->login_count ?? 0 }} lần</p>
                        </div>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-400 mb-1">Thời gian tham gia</label>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-gray-800 rounded-xl border border-gray-700 p-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <form action="{{ route('team-admin.users.destroy', $user) }}" method="POST" onsubmit="return confirm('Bạn có chắc chắn muốn xóa thành viên này khỏi team?')">
                            @csrf
                            @method('DELETE')
                ...
                <div class="bg-gray-800 rounded-xl border border-gray-700 p-6">
                    ...
                    <div class="space-y-3">
                        <div>
                            <label class="block text-sm font-medium text-gray-400 mb-1">Team hiện tại</label>
                            <p class="text-white font-medium">{{ auth()->user()->team->name ?? 'N/A' }}</p>
                        </div>
                        
                        <div>
                            <label class="block text-sm font-medium text-gray-400 mb-1">Vị trí trong team</label>
                            @if($user->roles->count() > 0)
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-400 mb-1">Ngày tham gia team</label>
