    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="mb-8">
            <div class="flex justify-between items-center mb-6">
                <div>
                    <h1 class="text-3xl font-bold text-white mb-2">Chỉnh sửa Thành viên</h1>
                    <p class="text-gray-400">Chỉnh sửa thông tin thành viên: <span class="text-blue-400 font-medium">{{ $user->name }}</span></p>
                </div>
        ...
        <div class="max-w-2xl mx-auto">
            <div class="bg-gray-800 rounded-xl border border-gray-700 p-6">
                <form method="POST" action="{{ route('team-admin.users.update', $user) }}">
                    ...
                    <!-- Password (Optional) -->
                    <div class="mb-6">
                        <label for="password" class="block text-sm font-medium text-gray-300 mb-2">Mật khẩu mới (để trống nếu không thay đổi)</label>
                    ...
                    <div class="mb-6">
                        ...
                        <p class="mt-1 text-sm text-gray-400">Thành viên sẽ luôn thuộc về team này</p>
                    </div>

                    <!-- Current Status -->
                    <div class="mb-6">
                        <label class="block text-sm font-medium text-gray-300 mb-2">Trạng thái hiện tại</label>
                ...
                <div class="flex items-start">
                    ...
                    <div>
                        ...
                        <ul class="text-sm text-gray-300 space-y-1">
                            ...
                            <li>• Thành viên sẽ luôn thuộc về team hiện tại</li>
                            <li>• Không thể thay đổi trạng thái xác thực email</li>
                        </ul>
                    </div>
                </div>
            </div>
