        ...
        <div class="mb-8">
            <div class="flex items-center mb-6">
                ...
                <div>
                    ...
                    <p class="text-gray-400">Create a new user with permissions</p>
                </div>
            </div>
        </div>
            ...
            <div class="bg-gray-800 rounded-xl border border-gray-700 p-6">
                <form action="{{ route('users.store') }}" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="mt-4">
                                <label for="tiktok_market" class="block text-sm font-medium text-gray-300 mb-2">TikTok market *</label>
                            <select id="tiktok_market" name="tiktok_market" required
                                    class="w-full bg-gray-700 border border-gray-600 rounded-lg px-4 py-2 text-white focus:outline-none focus:border-blue-500 @error('tiktok_market') border-red-500 @enderror">
                                <option value="">Select market</option>
                                <option value="US" {{ old('tiktok_market') == 'US' ? 'selected' : '' }}>US</option>
                                <option value="UK" {{ old('tiktok_market') == 'UK' ? 'selected' : '' }}>UK</option>
                            </select>
                            <p class="mt-1 text-sm text-gray-400">Required to select TikTok market for user to use categories and credentials for the correct market</p>
                            @error('tiktok_market')
                                <p class="text-red-400 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="flex items-center space-x-6">
                            <label class="flex items-center">
                                <input type="radio" name="is_system_user" value="0" {{ old('is_system_user', '0') == '0' ? 'checked' : '' }}
                            ...
                            <label class="flex items-center">
                                <input type="radio" name="is_system_user" value="1" {{ old('is_system_user') == '1' ? 'checked' : '' }}
                                       class="w-4 h-4 text-blue-600 bg-gray-700 border-gray-600 focus:ring-blue-500 focus:ring-2">
