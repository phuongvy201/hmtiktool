        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-1">
                <div class="bg-gray-800 rounded-xl border border-gray-700 p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center justify-between">
                            <span class="text-gray-400">TikTok market:</span>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-gray-800 rounded-xl border border-gray-700 p-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            <h4 class="text-sm font-medium text-gray-400 mb-2">Current role:</h4>
                        ...
                        <div>
                            <h4 class="text-sm font-medium text-gray-400 mb-2">Permissions:</h4>
                ...
                <div class="bg-gray-800 rounded-xl border border-gray-700 p-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center justify-between">
                                <span class="text-gray-400">Description:</span>
                                        <span class="text-gray-300">{{ $user->team->description ?? 'No description' }}</span>
                            </div>
                    ...
                    @else
                        <div class="text-center py-8">
                            ...
                            <p class="text-gray-400">This user is not assigned to any team</p>
                        </div>
                    @endif
                </div>
                ...
                <div class="bg-gray-800 rounded-xl border border-gray-700 p-6">
                    ...
                    <div class="text-center py-8">
                        ...
                        <p class="text-gray-400">No recent activity recorded</p>
                    </div>
                </div>
            </div>
        </div>
