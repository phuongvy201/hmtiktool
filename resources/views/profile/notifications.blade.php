        ...
        <div class="mb-8">
            <div class="flex items-center mb-6">
                ...
                <div>
                    ...
                    <p class="text-gray-400">Manage notifications and settings</p>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-1">
                <div class="bg-gray-800 rounded-xl border border-gray-700 p-6 mb-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center justify-between p-3 bg-gray-700 rounded-lg">
                            <div>
                                <h3 class="text-white font-medium">System notifications</h3>
                                <p class="text-gray-400 text-sm">Notifications in the application</p>
                            </div>
                            <label class="relative inline-flex items-center cursor-pointer">
                                <input type="checkbox" class="sr-only peer" checked>
                                <div class="w-11 h-6 bg-gray-600 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-800 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                        ...
                        <div class="flex items-center justify-between p-3 bg-gray-700 rounded-lg">
                            <div>
                                <h3 class="text-white font-medium">Security notifications</h3>
                                <p class="text-gray-400 text-sm">Security alerts</p>
                            </div>
                            <label class="relative inline-flex items-center cursor-pointer">
                                <input type="checkbox" class="sr-only peer" checked>
                                <div class="w-11 h-6 bg-gray-600 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-800 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
            ...
            <div class="lg:col-span-2">
                <div class="bg-gray-800 rounded-xl border border-gray-700 p-6">
                    ...
                    @if($notifications->count() > 0)
                                ...
                                <div class="flex items-start space-x-4 p-4 bg-gray-700 rounded-lg {{ !$notification->read_at ? 'border-l-4 border-blue-500' : '' }}">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <div class="flex items-start justify-between">
                                            <div class="flex-1">
                                                <p class="text-white font-medium">{{ $notification->title ?? 'Notification' }}</p>
                                                <p class="text-gray-400 text-sm mt-1">{{ $notification->message ?? 'Notification content' }}</p>
                        ...
                        <div class="mt-6">
                            <div class="flex items-center justify-between">
                                <p class="text-sm text-gray-400">Displaying {{ $notifications->count() }} notifications</p>
                                <div class="flex items-center space-x-2">
                                    <button class="px-3 py-1 bg-gray-600 hover:bg-gray-700 text-white text-sm rounded-lg transition-colors duration-200">
                                        Previous
                                    </button>
                    ...
                    @else
                        <div class="text-center py-12">
                            ...
                            <p class="mt-1 text-sm text-gray-400">You have read all notifications.</p>
                        </div>
                    @endif
                </div>
                ...
                <div class="bg-gray-800 rounded-xl border border-gray-700 p-6 mt-6">
                    <h2 class="text-xl font-semibold text-white mb-4">Notification types</h2>
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div class="bg-gray-700 rounded-lg p-4">
                            <div class="flex items-center mb-2">
                                ...
                                <h3 class="text-white font-medium">System</h3>
                            </div>
                            <p class="text-gray-400 text-sm">Notifications from the system</p>
                        </div>
                        ...
                        <div class="bg-gray-700 rounded-lg p-4">
                            <div class="flex items-center mb-2">
                                <div class="w-6 h-6 bg-green-500/20 rounded-full flex items-center justify-center mr-2">
                                    ...
                                    <h3 class="text-white font-medium">Update</h3>
                            </div>
                            <p class="text-gray-400 text-sm">Update notifications</p>
                        </div>
                    </div>
                </div>
            </div>
