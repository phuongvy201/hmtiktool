...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
        <div class="flex items-center justify-between mb-6">
            ...
            <div class="flex space-x-3">
                ...
                <button id="uploadToTikTokBtn" 
                    ...
                    <i class="fas fa-upload mr-2"></i>Upload to TikTok
                </button>
                @endcan
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-gray-700 rounded-lg p-4 border border-gray-600">
                            <h3 class="text-lg font-medium text-white mb-3">Price Information</h3>
                            <div class="space-y-2">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-sm text-white">
                                    ...
                                    @else
                                        <span class="text-gray-500">No template</span>
                                    @endif
                                </p>
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-400">Creator</label>
                                <p class="mt-1 text-sm text-white">{{ $product->user->name }}</p>
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-400">Created Date</label>
        ...
        <div class="bg-gray-800 rounded-lg shadow-sm border border-gray-700 overflow-hidden mt-6">
            <div class="p-6">
                <h3 class="text-lg font-medium text-white mb-4">All Product Images</h3>
        ...
        <div class="bg-gray-800 rounded-lg shadow-xl max-w-md w-full">
            <div class="p-6">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="text-lg font-medium text-white">Upload Images to TikTok</h3>
                ...
                <div id="uploadStatus" class="mb-4">
                    <div class="flex items-center">
                        ...
                        <span class="text-gray-300">Uploading images...</span>
                    </div>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    uploadBtn.addEventListener('click', function() {
        ...
        .catch(error => {
            ...
            successMessage.classList.add('hidden');
            errorMessage.classList.remove('hidden');
            errorText.textContent = 'An error occurred while uploading: ' + error.message;
        })
        .finally(() => {
            // Re-enable button
            uploadBtn.disabled = false;
            uploadBtn.innerHTML = '<i class="fas fa-upload mr-2"></i>Upload to TikTok';
        });
    });
