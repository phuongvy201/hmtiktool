...
@section('title', 'Blustack Partner Portal')

@section('header-subtitle', 'TikTok Partner')
@section('header-title', 'Blustack Operations Portal')

@section('header-extra-button')
...
@section('auth-button-text', 'Go to Dashboard')
