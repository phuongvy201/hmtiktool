    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="mb-8">
            <div class="flex items-center mb-6">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-white mb-2">Tạo Team TikTok Shop Mới</h1>
                    <p class="text-gray-400">Tạo team mới để quản lý TikTok Shop và thêm thành viên</p>
                </div>
            </div>
        </div>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" id="name" name="name" value="{{ old('name') }}" required
                                       placeholder="Ví dụ: Team TikTok Shop A, Team Quản lý Shop B..."
                        ...
                        <div class="mt-6">
                            ...
                            <textarea id="description" name="description" rows="4" 
                                      placeholder="Mô tả về team TikTok Shop, thương hiệu quản lý, chuyên môn..."
