...
// Test customer callback với state đơn giản (chỉ team_id)
...
echo "🧪 Testing customer callback với state đơn giản...\n";
echo "URL: " . $url . "\n\n";
...
if ($error) {
    ...
    file_put_contents('simple_callback_response.html', $response);
    echo "💾 Response đã được lưu vào simple_callback_response.html\n";
}
