...
// Test customer callback với URL mới
$url = 'http://127.0.0.1:8000/public/customer-callback?app_key=6h5b0bsgaonml&code=GCP_AhaQqQAAAAC73m1XWW50tl9OYJfkdb3pkcpvzhjDbo2XR6rqaWeUtHs4oIx_3t7y2jGdc1nIaLgvfvq_M3QIxI975FZp990UsbfAdK4xVaCPDPiEiXUIzk9uNsMsJML3J-bb0vF_Lps&locale=en-GB&shop_region=GB&state=eyJ0ZWFtX2lkIjo3LCJhdXRoX3Rva2VuIjoiZml4X3Rva2VuXzE3NTg2MTI2MjciLCJ0eXBlIjoiY3VzdG9tZXJfYXV0aCJ9';

echo "🧪 Testing customer callback với URL mới...\n";
echo "URL: " . $url . "\n\n";
...
if ($error) {
    ...
    file_put_contents('new_callback_response.html', $response);
    echo "💾 Response đã được lưu vào new_callback_response.html\n";
}
